...
namespace meta
{
    ...
    namespace detail
    {
        ...
        void foreach2(ctti::meta::list<Ts...>, ctti::meta::index_sequence<Indices...>, Function function)
        {
            (void)function;
    ...
    void foreach2(Function function)
    {
        ctti::meta::detail::foreach2(ctti::meta::apply_functor<ctti::meta::list<>, Sequence>(), ctti::meta::make_index_sequence_from_sequence<Sequence>(), function);
    }
}
